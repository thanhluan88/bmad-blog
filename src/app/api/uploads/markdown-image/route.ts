...
import { uploadCoverToBlob, buildMarkdownImageObjectPath } from "@/lib/storage";
...
export async function POST(request: NextRequest) {
  ...
  if (!token) {
    console.error("[uploads/markdown-image] Missing BLOB_READ_WRITE_TOKEN", {
      route: "/api/uploads/markdown-image",
  ...
  const objectPath = buildMarkdownImageObjectPath(postId, file.name);
  ...
  try {
    ...
    console.error("[uploads/markdown-image] Blob upload error", {
      route: "/api/uploads/markdown-image",
